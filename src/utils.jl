...
"""
    function _calculate_ratio(actual_reduction, g, H, s, ŝ, C, modified_reduction_for_ratio, to)
...
The actual reduction is modified by subtracting the quadratic term of the predicted reduction if `modified_reduction_for_ratio` is true.
...
- `modified_reduction_for_ratio::Bool`: A flag indicating whether to modify the actual reduction for the ratio calculation.
